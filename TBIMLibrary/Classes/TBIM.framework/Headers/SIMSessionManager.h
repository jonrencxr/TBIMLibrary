...
/**
 设置稍后处理
 */
- (NSURLSessionDataTask *)managerSetSessionPostpone:(NSMutableArray *)sessions complection:(void(^)(id resultObject, NSError *error))complection;

/**
 获取稍后处理列表
 */
- (NSURLSessionDataTask *)managerPostponeSessions:(SIMGetSessionResultArraySucc)complection fail:(SIMFail)fail;
@end
