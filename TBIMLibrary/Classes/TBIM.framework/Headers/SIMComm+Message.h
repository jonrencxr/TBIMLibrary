...
typedef NS_ENUM(NSInteger, SIMMsgType){
    ...
    SIMMsgType_REDENVELOPE = 15, //红包消息
    ...
    SIMMsgType_SYSTEM_PROHIBIT_ALL_MEMBERS = 20010, // 批量添加群成员禁言消息
    SIMMsgType_SYSTEM_PROHIBIT_MEMBERS = 20011, // 批量添加群成员禁言消息
    SIMMsgType_SYSTEM_REMOVED = 30001,   //  被踢出
    SIMMsgType_SYSTEM_DISBAND_GROUP = 30002,   //  群解散
    SIMMsgType_SYSTEM_QUIT_SELF = 30003,   //  自己退群通知
    SIMMsgType_RedEnvelope_Receive = 20103, // 红包领取通知
    SIMMsgType_RedEnvelope_Receive_All = 20104, // 红包领完
    SIMMsgType_RedEnvelope_Expired = 20105 // 红包过期
};
